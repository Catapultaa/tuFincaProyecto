      ...
      <div className="container mx-auto px-4 md:px-8 py-8">
          ...
          <div className="flex justify-between items-start">
            <div>
              ...
              <div className="flex items-center mt-2">
                ...
                <p className="text-xl text-gray-600">{propiedad.ubicacion}</p>
              </div>
            </div>
        ...
        <div className="mb-10 rounded-xl overflow-hidden shadow-xl">
          <ImageCarrousel
            propiedad={propiedad}
            fullSize
            className="h-[350px] md:h-[500px] lg:h-[600px]"
          />
        </div>

        {/* Código de propiedad */}
        <div className="mb-8 bg-blue-50 p-4 rounded-lg inline-block">
